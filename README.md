...
```
wget -N --no-check-certificate https://raw.githubusercontent.com/haobaicai490444883/hysteria2-install/main/hysteria2-install-main/hy2/hysteria.sh && bash hysteria.sh
```
